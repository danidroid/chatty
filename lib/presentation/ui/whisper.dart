...
class MyAppWhisper extends StatelessWidget {
  const MyAppWhisper({super.key});
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:
          const MyHomePageWhisper(title: 'Flutter Demo Whisper Speech to Text'),
    );
  }
}

class MyHomePageWhisper extends StatefulWidget {
  const MyHomePageWhisper({super.key, required this.title});

  final String title;

  @override
  State<MyHomePageWhisper> createState() => _MyHomePageWhisperState();
}

class _MyHomePageWhisperState extends State<MyHomePageWhisper> {
